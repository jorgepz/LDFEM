...
echo "  declarmodule."
gfortran -mcmodel=large -c -g materialmodule.f90 declarmodule.f90
echo "  materialmodule."
gfortran -mcmodel=large -c -g vtkmodule.f90 declarmodule.f90
echo "  vtkmodule."
gfortran -mcmodel=large -c -g elemmodule.f90 declarmodule.f90 usefull.f90
echo "  elemmodule."
gfortran -mcmodel=large -c -g boundarymodule.f90 declarmodule.f90 usefull.f90
echo "  boundarymodule."
gfortran -mcmodel=large -c -g ldfem.f90 vtkmodule.f90 elemmodule.f90 declarmodule.f90 usefull.f90 \
  boundarymodule.f90 materialmodule.f90
echo "  ldfem."
echo "OK."
...
gfortran -mcmodel=large -o ldfem.lnx ldfem.o vtkmodule.o elemmodule.o declarmodule.o usefull.o \
  boundarymodule.o  materialmodule.o \
  -llapack -lblas
